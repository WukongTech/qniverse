...
from my_mean_functions import Zero
...
class DGP_Quad(DGP_Base):
    ...
    def __init__(self, *args, H=100, **kwargs):
        ...
        self.gh_x.append(tf.zeros((1, 1, 1), dtype=float_type))
...
class DGP(DGP_Base):
    ...
    def __setattr__(self, name, value):
        try:
            DGP_Base.__setattr__(self, name, value)
        except:
    ...
    def __init__(self, X, Y, Z, kernels, likelihood,
                 ...
                 white=False, minibatch_size=512, **kwargs):
